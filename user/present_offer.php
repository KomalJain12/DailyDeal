...
$curdate=date('Y-m-d');
$timee=time('h:i:s');
$q="select p.*,o.* from offer o, product_detail p where p.pid=o.pid and exdate='$curdate' ORDER BY oid desc;";
												...
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															...
															<h4>Deal of the day <b><?php echo $row['exdate']; ?></b></h4>
														</div>
