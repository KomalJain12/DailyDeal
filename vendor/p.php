...
if(isset($_POST['btninsert']))
  {
    ...
    //echo "insert into product_detail values('',$sid,$vid,'$pname','$sku','$brand','$description','$rate','$mrp','$stock','$file_name')";
    $q=mysqli_query($con,"insert into product_detail values('',$sid,$vid,'$pname','$sku','$brand','$desc','$rate','$mrp','$stock','$file_name')");
    if($q)
    {
